...
class TwoFactorMiddleware implements MiddlewareInterface
{
    ...
    public function __construct(ContainerInterface $container, private TwoFactorAuthModel $two_factor_auth_model)
    {
    ...
    public function process(Request $request, RequestHandler $handler): ResponseInterface
    {
        ...
        $has2FAEnabled = $this->two_factor_auth_model->isEnabled(SessionManager::get('user_id'));
        ...
        $isVerified = SessionManager::get('two_factor_verified');
