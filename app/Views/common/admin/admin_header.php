...
<body>
    ...
    <div
        ...
        <button
            class="btn btn-primary py-2 dropdown-toggle d-flex align-items-center mt-3"
            id="bd-theme"
            type="button"
            aria-expanded="false"
            data-bs-toggle="dropdown"
            ...
            <div
                ...
                <div
                    ...
                    <div
                        ...
                        <ul class="nav flex-column mb-auto">
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2" href="2fa/dashboard">
                                    <svg class="bi" aria-hidden="true">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2" href="<?=APP_ADMIN_URL?>logout" >
                                    <svg class="bi" aria-hidden="true">
